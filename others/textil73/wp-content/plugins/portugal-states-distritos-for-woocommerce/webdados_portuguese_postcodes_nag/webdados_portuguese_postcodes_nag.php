	...
	function webdados_portuguese_postcodes_nag() {
		...
		<div id="webdados_portuguese_postcodes_nag" class="notice notice-info is-dismissible">
			<p style="line-height: 1.4em;">
				...
				<strong><?php _e( 'Do your customers still write the full postal code manually on the checkout?', 'portugal-states-distritos-for-woocommerce'); ?></strong>
				<br/>
				<?php echo sprintf(
					__( 'Activate the automatic filling of the postal code at the checkout, avoiding incorrect data at the time of sending, with our plugin %1$sPortuguese Postcodes for WooCommerce%2$s', 'portugal-states-distritos-for-woocommerce' ),
					sprintf(
						'<a href="%s" target="_blank">',
						esc_url( __( 'https://www.webdados.pt/wordpress/plugins/codigos-postais-portugueses-para-woocommerce/', 'portugal-states-distritos-for-woocommerce' ) )
					),
					'</a>'
				); ?>
				<br/>
