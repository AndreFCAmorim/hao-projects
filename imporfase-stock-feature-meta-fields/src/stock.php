...
function impor_ajax_get_terms() {
	...
	//Association between Peças, Oficina and Custom.
	//Discount Type = pecas or oficina
	$client_discount_type = get_client_field( $meta_info, $client_id, 'tipo' );

	if ( ! empty( $client_discount_type ) ) {
		if ( strpos( $client_discount_type, 'pecas' ) !== false ) {
			//Peças
			$client_discounts['a'] = 55;
			$client_discounts['d'] = 55;
			$client_discounts['g'] = 55;
			$client_discounts['j'] = 60;
			$client_discounts['w'] = 60;
			$client_discounts['t'] = 60;
			$client_discounts['p'] = 60;
			$client_discounts['y'] = 55;
			$client_discounts['z'] = 60;
		} else {
			//Oficina
			$client_discounts['a'] = 60;
			$client_discounts['d'] = 65;
			$client_discounts['g'] = 60;
			$client_discounts['j'] = 65;
			$client_discounts['w'] = 65;
			$client_discounts['t'] = 65;
			$client_discounts['p'] = 65;
			$client_discounts['y'] = 60;
			$client_discounts['z'] = 65;
		}
	}
...
function validate_form( $post ) {
	...
	$client_telf = $client_telf ?? 'Sem telefone';
	$client_code = $client_code ?? 'Sem codigo';
	$client_refs = $client_refs ?? 'Sem refs';
	$client_mail = $client_mail ? $client_mail : 'imporfase@gmail.com';
