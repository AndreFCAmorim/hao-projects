...
if ( isset( $email_status->body['message'] ) && $email_status->body['message'] == 'success' ) {
	...
	echo '<div class="gos_mail gos_mail__failure"><p>O seu email não foi enviado, lamentamos. Por favor contacte-nos para <a href="mailto:vendasandre@hopeandoak.agency">vendasandre@hopeandoak.agency</a>!</p></div>';
}
...
<div class="email__order">
	...
	<form
		...
		<div class="col-md-12">
			<div class="form-group" >
				<p class="email__cart-label-remove" style="display:none;"><?php _e( 'Remover', 'impstock' ); ?></p>
				<label class="email__cart-label" for="email__cart-table"><?php _e( 'Referências a encomendar', 'impstock' ); ?></label>
				<table
					class="email__cart-table"><tbody></tbody></table>
				<textarea
					class ="form-control"
					id ="email__encs"
					name ="email__encs"
		...
		<div class="col-md-3">
			<div class="form-group" >
				<table class="email__totals">
					<tr>
						<th><?php esc_html_e( 'PVP', 'impstock' ); ?></th>
						<th><?php esc_html_e( 'Desconto', 'impstock' ); ?></th>
						<th><?php esc_html_e( 'Total', 'impstock' ); ?></th>
					</tr>
					<tr>
						<td id="email__totals-pvp">0,00 €</td>
						<td id="email__totals-discount">0,00 €</td>
						<td id="email__totals-total">0,00 €</td>
					</tr>
				</table>
			</div>
		</div>
