module.exports = function( grunt ) {
  ...
  grunt.initConfig( {
    ...
    sass: {
      ...
      dev: {
        files: {
          'dist/css/dba_theme.css':       'assets/css/scss/main.scss',
          'dist/css/dba_theme-admin.css': 'assets/css/scss/admin.scss',
          'dist/css/dba_theme-edit.css':  'assets/css/scss/edit.scss'
        }
      },
    ...
    postcss: {
      ...
      dev: {
        ...
        src:  'dist/css/dba_theme.css',
        dest: 'dist/css/dba_theme.css'
      },
      ...
      build: {
        ...
        files: {
          'dist/css/dba_theme.min.css':       'dist/css/dba_theme.css',
          'dist/css/dba_theme-admin.min.css': 'dist/css/dba_theme-admin.css',
          'dist/css/dba_theme-edit.min.css':  'dist/css/dba_theme-edit.css',
    ...
    terser: {
      ...
      prod: {
        ...
        files: {
          'dist/js/dba_theme.min.js': ['dist/js/dba_theme.js']
        }
      }
    },
  ...
  grunt.registerTask('bs-inject-css', function () {
    browserSync.reload([
      'dist/css/dba_theme.css'
    ]);
  });
  // Reload browser
  grunt.registerTask('bs-reload', function () {
    browserSync.reload([
      'dist/js/dba_theme.js',
      './**/*.php'
    ]);
  });
