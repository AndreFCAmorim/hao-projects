module.exports = function( grunt ) {
  ...
  grunt.registerTask('bs-init', function () {
    ...
    browserSync({
      ...
      timestamps: true,
      proxy:      {
        target: 'https://pedromarquesmep.test'
      }
    }, function (err, bs) {
      done();
    });
  ...
  // Default task.
  grunt.registerTask( 'default', ['concat', 'sasslint', 'sass:dev', 'postcss:dev', 'svgstore', 'bs-init', 'watch'] ); // runs watch tasks one time and then activates watch
