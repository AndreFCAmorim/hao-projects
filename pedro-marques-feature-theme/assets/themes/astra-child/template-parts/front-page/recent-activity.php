...
$max_items       = 3;
$recent_activity = get_recent_activity( $max_items );
...
if ( $items_count < $max_items ) {
	...
	$recent_activity = get_recent_activity_extra( $max_items - $items_count, $items_ids );
...
if ( $items_count > 0 ) {
	printf(
		...
		esc_url( get_post_type_archive_link( 'event' ) . '?filter=activity' ),
