...
$max_items       = 3;
$recent_activity = get_recent_activity( $max_items, get_queried_object()->name );
...
if ( $items_count < $max_items ) {
	...
	$recent_activity = get_recent_activity_extra( $max_items - $items_count, $items_ids, get_queried_object()->name );
