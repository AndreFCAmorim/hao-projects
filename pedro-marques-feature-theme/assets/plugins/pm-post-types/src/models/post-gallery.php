...
return [
	...
	'labels'       => [
		'has_one'     => __( 'Image', 'pm-cpt' ),
		'has_many'    => __( 'Gallery', 'pm-cpt' ),
		'text_domain' => 'pm-cpt',

		// optional, but better for translation
		'overrides'   => [
			'labels'        => [
				'name'                  => __( 'Gallery', 'pm-cpt' ),
				'singular_name'         => __( 'Image', 'pm-cpt' ),
				'menu_name'             => __( 'Gallery', 'pm-cpt' ),
				'name_admin_bar'        => __( 'Image', 'pm-cpt' ),
				...
				'information' => [
					...
					'fields' => [
						'gallery-image'  => [
							...
							'type'    => 'media',
							'library' => 'image',
							'desc'    => __( 'The image for this gallery. Recommended resolution: 1920x1020.', 'pm-cpt' ),
						],
						'is_highlighted' => [
							'title'   => __( 'Is Highlighted', 'pm-cpt' ),
							'type'    => 'switcher',
							'label'   => __( 'Is Highlighted?', 'pm-cpt' ),
							'default' => false,
						],
					],
				],
