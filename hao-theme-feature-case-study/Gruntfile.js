module.exports = function( grunt ) {
  ...
  grunt.initConfig( {
    ...
    sass: {
      ...
      dev: {
        files: {
          'dist/css/hao_theme.css':       'assets/css/scss/main.scss',
          'dist/css/hao_theme-admin.css': 'assets/css/scss/admin.scss',
          'dist/css/hao_theme-edit.css':  'assets/css/scss/edit.scss'
        }
      },
    ...
    postcss: {
      ...
      dev: {
        ...
        src:  'dist/css/hao_theme.css',
        dest: 'dist/css/hao_theme.css'
      },
      ...
      build: {
        ...
        files: {
          'dist/css/hao_theme.min.css':       'dist/css/hao_theme.css',
          'dist/css/hao_theme-admin.min.css': 'dist/css/hao_theme-admin.css',
          'dist/css/hao_theme-edit.min.css':  'dist/css/hao_theme-edit.css',
    ...
    terser: {
      ...
      prod: {
        ...
        files: {
          'dist/js/hao_theme.min.js': ['dist/js/hao_theme.js']
        }
      }
    },
  ...
  grunt.registerTask('bs-inject-css', function () {
    browserSync.reload([
      'dist/css/hao_theme.css'
    ]);
  });
  // Reload browser
  grunt.registerTask('bs-reload', function () {
    browserSync.reload([
      'dist/js/hao_theme.js',
      './**/*.php'
    ]);
  });
